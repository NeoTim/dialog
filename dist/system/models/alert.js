System.register(['../dialog-controller', './baseDialog'], function (_export) {
  'use strict';

  var DialogController, BaseDialog, Alert;
  ...
  return {
    setters: [function (_dialogController) {
      ...
      BaseDialog = _baseDialog.BaseDialog;
    }],
    execute: function () {
      Alert = (function (_BaseDialog) {
